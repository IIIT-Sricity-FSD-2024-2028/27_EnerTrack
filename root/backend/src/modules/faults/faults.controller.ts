...
export class FaultsController {
  ...
  @Post()
  @ApiOperation({ summary: "Create Fault", description: "Logs a new equipment fault, optionally linked to an alert. Organization Admin and Technician can create faults." })
  ...
  @Get()
  @ApiOperation({ summary: "List All Faults", description: "Retrieves all fault records. Organization Admin and Technician can view faults." })
  ...
  @Get(":id")
  @ApiOperation({ summary: "Get Fault by ID", description: "Retrieves a single fault by UUID. Organization Admin and Technician can look up faults." })
  ...
  @Put(":id")
  @ApiOperation({ summary: "Replace Fault", description: "Completely replaces an existing fault record. Only Organization Admin can perform full replacements." })
  ...
  @Patch(":id")
  @ApiOperation({ summary: "Update Fault", description: "Partially updates a fault (e.g., status, reassigning Technician). Organization Admin and Technician can update." })
  ...
  @Delete(":id")
  @ApiOperation({ summary: "Delete Fault", description: "Permanently removes a fault record. Only the Organization Admin can delete faults." })
  ...
  @Get(":id/work-orders")
  @ApiOperation({ summary: "Get Work Orders for Fault", description: "Retrieves all work orders linked to a fault. Organization Admin and Technician can view." })
