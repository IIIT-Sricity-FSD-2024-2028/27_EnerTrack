...
export class BuildingsController {
  ...
  @Post()
  @ApiOperation({ summary: "Create Building", description: "Creates a new building record under a campus. Only the Organization Admin can add buildings by providing campus_id, name, and optional budget. Send a POST request with a CreateBuildingDto JSON body." })
  ...
  @Put(":id")
  @ApiOperation({ summary: "Replace Building", description: "Completely replaces an existing building record with new data. Only the Organization Admin can perform full building replacements. Send a PUT request with the building_id in the URL and a complete PutBuildingDto JSON body." })
  ...
  @Delete(":id")
  @ApiOperation({ summary: "Delete Building", description: "Permanently removes a building record from the system. Only the Organization Admin can delete buildings. Pass the building_id as a URL path parameter." })
