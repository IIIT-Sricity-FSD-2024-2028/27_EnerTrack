...
var NotificationsController = function () {
    ...
    var NotificationsController = _classThis = /** @class */ (function () {
        ...
        NotificationsController_1.prototype.create = function (createDto) {
            return this.notificationsService.create(createDto);
        };
        NotificationsController_1.prototype.findAll = function () {
            return this.notificationsService.findAll();
        };
        NotificationsController_1.prototype.findOne = function (id) {
            return this.notificationsService.findOne(id);
        };
        NotificationsController_1.prototype.update = function (id, updateDto) {
            return this.notificationsService.update(id, updateDto);
        };
        NotificationsController_1.prototype.remove = function (id) {
