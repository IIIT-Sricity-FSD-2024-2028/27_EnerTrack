...
export class EnergyCostsController {
  ...
  @Post()
  @ApiOperation({ summary: "Create Energy Cost", description: "Records a new energy cost entry for a building/department for a given period. Financial Analyst and Organization Admin can create." })
  ...
  @Get()
  @ApiOperation({ summary: "List All Energy Costs", description: "Retrieves all energy cost records. Financial Analyst and Organization Admin can view energy cost data." })
  ...
  @Get(":id")
  @ApiOperation({ summary: "Get Energy Cost by ID", description: "Retrieves a single energy cost record by UUID. Financial Analyst and Organization Admin can look up records." })
  ...
  @Put(":id")
  @ApiOperation({ summary: "Replace Energy Cost", description: "Completely replaces an energy cost record. Only Organization Admin can perform full replacements." })
  ...
  @Patch(":id")
  @ApiOperation({ summary: "Update Energy Cost", description: "Partially updates an energy cost record (e.g., adjusting costs or budget status). Financial Analyst and Organization Admin can update." })
  ...
  @Delete(":id")
  @ApiOperation({ summary: "Delete Energy Cost", description: "Permanently removes an energy cost record. Only Organization Admin can delete." })
  ...
  @ApiOperation({ summary: "Get Energy Costs by Period", description: "Retrieves energy costs for a specific billing period (e.g., '2025-03'). Financial Analyst and Organization Admin can filter by period." })
