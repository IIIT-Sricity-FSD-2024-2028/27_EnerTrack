 ...
 * Used by: system_admin_maintain.html, system_admin_overview.html
 */
...
/* ── RENDER (system_admin_maintain.html) ─────────────────── */
...
function buildUpdateCard(upd) {
  ...
  const actions = roleAllowed(["system_admin", "superuser"]) ? `
...
/* ── RENDER (system_admin_overview.html) ─────────────────── */
...
export function renderOverviewUpdates(containerId = "overviewUpdatesContainer") {
  ...
  //         ${roleAllowed(["system_admin", "superuser"]) ? `
