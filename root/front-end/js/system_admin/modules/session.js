 ...
 * Used by: all system_admin pages.
 */
...
export function initSession() {
  ...
  if (stored) {
    ...
    // Persist the default mock system_admin user
 ...
 * decorated with data-roles="system_admin,superuser" attributes.
 */
export function renderSessionUI() {
  ...
  // Role-gated elements: <button data-roles="system_admin,superuser">
...
function roleLabel(role) {
  return { superuser: "Super User", system_admin: "System Admin", enduser: "End User" }[role] ?? role;
}
...
export function switchRole(role) {
  const allowed = ["superuser", "system_admin", "enduser"];
